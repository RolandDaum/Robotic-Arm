...
public void main(String[] args) {
    PositionAngleV2 idk = new PositionAngleV2(new Vector3D(10,0,125), new Vector3D(1,1,1)); // x and y of Point vector *-1 !!!
...
public class PositionAngleV2 {
    ...
    void t3t4() {
        ...
        Vector3D vDP = Vector3D.subtract(vD, Vector3D.scale(vL34, x));
        Vector3D vY = Vector3D.crossP(vDP, new Vector3D(0,0,l[5]));
